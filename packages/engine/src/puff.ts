...
/* ย้ายมาจาก smoke-plume-studio-lasted.html บรรทัด 691-856 โดยไม่แก้ตรรกะ
   ...
   **หมายเหตุสำคัญ** โหมดนี้มีบั๊กที่รู้อยู่ ตาม HANDOFF-terrain-mode.md ข้อ 1
   ความเข้มข้นระดับพื้นบนภูมิประเทศถูกกดจนแทบเป็นศูนย์ ยังไม่แก้ในงานรื้อโครง
   golden test ล็อกพฤติกรรมที่ผิดนี้ไว้เพื่อพิสูจน์ว่าการย้ายไม่เปลี่ยนอะไร */
  ...
  for(var h=0; h<nH; h++){
    ...
    for(var s2=0; s2<steps; s2++){
      ...
      for(var pi2=puffs.length-1; pi2>=0; pi2--){
        ...
        var sg = sigmas(Math.max(pf.d, 12), st);
