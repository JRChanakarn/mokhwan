...
**เกณฑ์ 3 ผ่าน** ควันหยุดที่ตีนดอย ไม่ปีนข้าม (ภาพ: พลูมแคบพุ่งตะวันตก ~3.5 กม. แล้วชะงัก
ที่ขอบ hillshade) · **เกณฑ์ 4 ผ่าน** โหมด 2D เห็น hillshade + เส้นชั้นความสูงใต้ควัน ·
